 ...
 * <p> O(k^2)
 * Hints:
 * <p> 1. https://leetcode.com/problems/maximum-score-from-performing-multiplication-operations/discuss/1075469/JavaC%2B%2BPython-3-Top-Down-DP-O(m2)-Clean-and-Concise
...
public class LC_1770_Maximum_Score_Multiplication_Operations {
    ...
    public int maximumScore(int[] nums, int[] multipliers) {
        len = nums.length;
        k = multipliers.length; //  the picking #
        this.nums = nums;
